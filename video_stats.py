...
def extract_video_data(video_ids):
    ...
    try:
        for batch in batch_list(video_ids, maxResults):
            ...
            url = f"https://youtube.googleapis.com/youtube/v3/videos?part=contentDetails&part=snippet&part=statistics&id={video_ids_str}&key={API_KEY}"  # noqa: E501
...
if __name__ == "__main__":
    ...
    exctracted_vid_data = extract_video_data(video_ids)
    save_to_json(exctracted_vid_data)
